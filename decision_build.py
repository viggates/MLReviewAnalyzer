...
min_data_per_class = 3  # used to determine number of samples required for each class.Classes with less than that will be excluded from the dataset. default value is 1
...
#        count_vect = CountVectorizer(analyzer='word', stop_words=frozenset(mysw),strip_accents='unicode',ngram_range=(3,7),min_df=3,max_df=3000,binary=False)
    elif use_stemming:
